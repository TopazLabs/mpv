...
namespace aiengine {
    ...
    protected:
        bool _isFP16 = false, _fixOutputName = false;
    ...
    public:
        explicit OXInput(unsigned int backendIndex, bool fixInputNames = false, bool fixOutputName = false, bool isFP16 = false): ModelInput(backendIndex, fixInputNames), _fixOutputName(fixOutputName), _isFP16(isFP16) {
