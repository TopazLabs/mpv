...
private:
    ...
    float _osVersion = 0;
    bool _supportsAVX = false, _supportsAVX2 = false, _isWindows = false, _isLinux = false, _supportsVNNI = false, _messagesEnabled = false;
    int _nativeThreadCount = 0;
    string _cpuName;
    bool _hasGLModels = false;
    string _machineId;
    ...
    SystemInfo() : _messagesEnabled(strutils::getEnv("TOPAZ_AIE_MESSAGES") == "1") {
        loadSystemFeatures();
        logSystemInfo();
    }
public:
