 ...
 *****************************************************************************/
/*  
 *  Description:    RLM common external definitions
 *
 *  M. Christiano
 *  11/19/05
 *
...
#ifndef RLM_LICENSE_COMMON_H_INCLUDED
#define RLM_LICENSE_COMMON_H_INCLUDED
...
#define RLM_COPYRIGHT  "Copyright (C) 2006-2024, Reprise Software, Inc. All rights reserved."

#define RLM_VERSION 16
#define RLM_REVISION 1
#define RLM_BUILD 1
#define RLM_PATCH 0
...
#define RLM_MAX_ISV_ENV_NAME 18
    /*
...
#define RLM_REHOST_NO_ROOT  -11 /* No root dir for rehostable */
#define RLM_REHOST_NO_TOP   -12 /* No/bad top-level hostid file */
#define RLM_REHOST_NO_HOSTID    -34 /* check_rehost(): no hostid supplied */
#define RLM_REHOST_BAD_DESC -35 /* check_rehost(): bad data in file */
#define RLM_REHOST_NO_DESC  -36 /* can't read descriptorfile */
#define RLM_REHOST_NOT_REF  -37 /* check_rehost(): not on ref hostid */
#define RLM_REHOST_BAD_DIGEST   -38 /* bad digest in hostid file */
#define RLM_REHOST_BAD_HOSTID   -39 /* hostid doesn't match file */
#define RLM_REHOST_NO_LEAF  -40 /* can't get to leaf directory */
#define RLM_REHOST_NO_LEAF_DATA -41 /* can't read leaf data */
#define RLM_REHOST_FILE_FMT -42 /* hostid format in file corrupted */
#define RLM_REHOST_TIME_ERR -43 /* hostid time incorrect */
#define RLM_REHOST_FID_ERR  -44 /* file ID error */
#define RLM_REHOST_BAD_HIER -45 /* file hierarchy corrupted */
#define RLM_ROAM_NOOPENFILE -46 /* Can't open roam file */
#define RLM_ROAM_BADDATALEN -47 /* Roam data length too long */
#define RLM_ROAM_WRONGDATALEN   -48 /* Roam data length mismatch */
#define RLM_ROAM_BADNUMFIELDS   -49 /* Roam data # of fields mismatch */
#define RLM_ROAM_APRODLEN   -50 /* Auth product length bad */
#define RLM_ROAM_LPRODLEN   -51 /* Lic product length bad */
#define RLM_ROAM_AVERLEN    -52 /* Auth ver length bad */
#define RLM_ROAM_LVERLEN    -53 /* Lic ver length bad */
#define RLM_ROAM_EXPLEN     -54 /* Exp length bad */

#define RLM_BADPARAM_LAST   -54 /* Last badparam sub-error */
    /*
     *  End of BADPARAM/INTERNAL sub-errors (in syserr)
     */
...
#define RLM_EH_TOOMUCHJSON  -185    /* JSON reply too big */
#define RLM_EH_NOLICFROMSERV    -186    /* Server returned no temp license */
#define RLM_EH_TEMPFROMCLOUD    -187    /* temp license creation on RLMCloud only */
#define RLM_EH_NOTTEMP      -188    /* License isn't a temporary license */
#define RLM_EH_NOLICENSE    -189    /* No License supplied to call */
#define RLM_EH_NOTEMPFROMLOCAL  -190    /* local license can't be used to create
                                           a new temporary license */
#define RLM_EH_NOHTTPSSUPPORT   -191    /* actpro https support missing */
#define RLM_EH_NOHTTPSDATA  -192    /* actpro https - no returned data */
#define RLM_EH_NOTTHISHOST  -193    /* like RLM_EL_NOTTHISHOST */
#define RLM_EH_NOTRANSBIN   -194    /* No support for translated binaries */
#define RLM_EH_NOTEMPDIR    -195    /* RLM temp directory can't be created (MAC) */
#define RLM_EH_TEAMS_UNLICENSED -196    /* RLM Teams Unlicensed */

#define RLM_EH_MAX_ERRS 96

#define RLM_EH_ERR(x) ((x <= -RLM_HANDLE_ERR_FIRST) && \
        (x > -(RLM_HANDLE_ERR_FIRST+RLM_EH_MAX_ERRS)))
...
#define RLM_EL_PERS_NOT_ON_LIST -72 /* Personal license: not on list */
#define RLM_EL_PERS_BADPASS -73 /* Personal license: incorrect pw */
#define RLM_EL_PERS_INUSE   -74 /* Personal license in use */
#define RLM_EL_PERS_HANDLE_ERR  -75 /* RLM Handle error */
#define RLM_EL_NOTTEMP      -76 /* License isn't a temporary license */
#define RLM_EL_NOSERVER     -77 /* No server to connect to return temp*/

#define RLM_EL_MAX_ERRS 77

    /*
     *  Activation/teams errors
     */
...
#define RLM_TEAMS_CANT_WRITE_ENT -1045 /* Can't write ent fulfill table */
#define RLM_TEAMS_ENT_EXPIRED   -1046 /* Entitlement expired */
#define RLM_TEAMS_PROD_EXPIRED  -1047 /* Teams product definition expired */
#define RLM_TEAMS_VER_TOOHIGH   -1048 /* Teams product definition expired */
#define RLM_TEAMS_NO_FULFILLMENT -1049 /* No Teams fulfillment for this host */
#define RLM_TEAMS_BAD_SETTINGS  -1050 /* No Teams fulfillment for this host */
#define RLM_ACT_ERR_LAST    50

#define RLM_ACT_ERR(x) ((x <= -RLM_ACT_ERR_FIRST) && \
        (x > -(RLM_ACT_ERR_FIRST+RLM_ACT_ERR_LAST)))

#endif /* RLM_LICENSE_COMMON_H_INCLUDED */
/******************************************************************************
...
#define RLM_SOFTWARE_VERSION  "Reprise License Manager (RLM) v16.1, Copyright (C) 2006-2024, Reprise Software, Inc."
...
typedef struct rlm_temp_handle *RLM_TEMP_HANDLE;
...
/*
 *  Flags (bits) for rlm_act_rehost_revoke()
 */
#define RLM_ACT_REVOKE_REFERENCE 1
#define RLM_ACT_REVOKE_NOFULFILL 2
#define RLM_ACT_REVOKE_NODEL 4
...
/* parameters" string */
#define RLM_ACT_MAX_LICTEXT 30720 /* Max length of string to prepend to lic */
/* changed from 1024 to 30720 (30kb) in 14.3 */
/*
...
#define RLM_LA_SUBSCRIPTION_TYPE 0x8

/*
 *  Sources for Temporary licenses
 */
#define RLM_TEMP_RLMCLOUD 1
#define RLM_TEMP_ACTPRO 2

/*
 *  Created temporary license types
 */
#define RLM_TEMP_UNCOUNTED 1
#define RLM_TEMP_SINGLE 2

/*
 *  RLM_TEMP_HANDLE member settings
 */

#define RLM_TEMP_HANDLE_AKEY    1
#define RLM_TEMP_HANDLE_COUNT   2
#define RLM_TEMP_HANDLE_DURATION 3
#define RLM_TEMP_HANDLE_LICENSE 4
#define RLM_TEMP_HANDLE_NEW_DURATION 5
#define RLM_TEMP_HANDLE_SOURCE  6
#define RLM_TEMP_HANDLE_TYPE    7
#define RLM_TEMP_HANDLE_URL 8
#define RLM_TEMP_HANDLE_WINDOW  9
...
extern void         rlm_isv_cfg_no_server_license_fail(RLM_HANDLE, 
        int);
extern void         rlm_isv_cfg_set_ash_start_tolerance(RLM_HANDLE,
        int);
...
extern void         rlm_isv_cfg_set_old_isv_name(RLM_HANDLE,char *);
extern void         rlm_isv_cfg_set_old_isv_name2(RLM_HANDLE,char *);
...
extern int          rlm_return_temp_license(RLM_LICENSE);
...
extern char *       rlm_license_exptime(RLM_LICENSE lic);
...
extern int      rlm_license_personal(RLM_LICENSE lic);
...
extern char *       rlm_license_teams(RLM_LICENSE lic);
...
extern char *       rlm_product_exptime(RLM_PRODUCTS);
...
extern int      rlm_product_isalias(RLM_PRODUCTS);
extern int      rlm_product_isfloating(RLM_PRODUCTS);
extern int      rlm_product_ismetered(RLM_PRODUCTS);
extern int      rlm_product_isnodelocked(RLM_PRODUCTS);
extern int      rlm_product_issingle(RLM_PRODUCTS);
...
extern int      rlm_product_personal(RLM_PRODUCTS);
...
extern void     rlm_temp_destroy_handle(RLM_TEMP_HANDLE handle);
extern RLM_TEMP_HANDLE  rlm_temp_new_handle(RLM_HANDLE rh);
extern int      rlm_temp_set_handle(RLM_TEMP_HANDLE handle, int what, 
        const void *val);
...
extern int      rlm_act_set_handle(RLM_ACT_HANDLE handle, int what, 
        const void *val);
extern int      rlm_act_rehost_revoke(RLM_HANDLE rh, const char *url,
        const char *product, int flags);
...
extern int rlm_create_temp_license(RLM_HANDLE rh, RLM_TEMP_HANDLE h);
